...
export const FakeVideo = forwardRef<FakeVideoHandle, FakeVideoProps>(
  function FakeVideo({ className, onPause, onPlay }, ref) {
    ...
    function tick(time: number) {
      ...
      currentTimeRef.current =
        (currentTimeRef.current + (time - previousTickTime) / 1000) % DURATION;
      draw();
